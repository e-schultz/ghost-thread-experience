      ...
      <div className="w-full max-w-4xl h-full max-h-[90vh] bg-terminal-black border-2 border-green-500 overflow-hidden flex flex-col rounded">
        ...
        <div className="flex-1 overflow-y-auto p-4">
          ...
          {bridgeData.content_summary && (
            <div className="mb-6 border border-green-500/50 rounded p-4">
              <div className="text-green-400 font-semibold mb-2">Content Summary</div>
              <div className="text-terminal-pink text-sm">
                {bridgeData.content_summary}
              </div>
            </div>
          )}
